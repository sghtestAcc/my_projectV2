              ...
              child: const Column(
                children: [
                  Row(
                    ...
                    children: [
                      Text('PatientName 1', style: TextStyle(fontSize: 15),),
                      Text('Quantity', style: TextStyle(fontSize: 15),),
                      Text('Schedule', style: TextStyle(fontSize: 15),),
                    ],
                  ),
                  SizedBox(height: 10,),
                  Row(
                    children: [
                      Text('xxx@gmail.com', style: TextStyle(fontSize: 15),),
                    ],
                  ),
                  SizedBox(height: 20,),
                   Row(
                     mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('Medication 1', style: TextStyle(fontSize: 15),),
                      Text('3 tabs', style: TextStyle(fontSize: 15),),
                      Text('Morning \n After meals', style: TextStyle(fontSize: 15),)
                    ],
