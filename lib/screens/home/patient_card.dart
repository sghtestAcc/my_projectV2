        ...
        if (snapshot.connectionState == ConnectionState.done) {
          if (snapshot.hasData) {
            ...
            List<GraceUser> filteredPatients = patients.where((patient) {
              ...
              return email.toLowerCase().contains(lol.toLowerCase()) ||
                          ...
                          children: [
                            ...
                            if (isDropdownOpen)
                              FutureBuilder<List<Medication>>(
                                future:
                                    userRepo.getAllPatientsMedications(email),
                                builder: (context, snapshot) {
                                  if (snapshot.connectionState ==
                                    ...
                                    if (snapshot.hasData) {
                                      ...
                                      var patientsInfoMedicationAll =
                                          snapshot.data;
                                      for (var i = 0;
                                          i < patientsInfoMedicationAll!.length;
                                          i++) {
                                        childrenfields.add(
                                          Row(
                                              mainAxisAlignment:
