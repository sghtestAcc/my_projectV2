          ...
          child: Form(
            ...
            child: Column(
              mainAxisAlignment: MainAxisAlignment
                  .center, // Center the column children vertically
              children: [
                Image.asset(
                ...
                Text(
                  AppLocalizations.of(context)!.passwordResetInstruction,
                  style: const TextStyle(fontSize: 20),
                ),
                const SizedBox(
                  height: 20,
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    ...
                    if (value == null || value.isEmpty) {
                      ...
                      return AppLocalizations.of(context)!.emailResetValidation;
                    }
                    return null;
                  },
                    ...
                    onPressed: () {
                      if (formData.currentState!.validate()) {
                        AuthenticationRepository.instance.forgetpassword(
                            emailformfield.text.trim(), context);
