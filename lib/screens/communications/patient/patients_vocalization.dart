          ...
          child: Column(
            children: [
              ...
              StreamBuilder<List<Medication>>(
                  stream: userRepo.getAllPatientMedications(currentUid!),
                        ...
                        child: ListView.separated(
                            ...
                            itemBuilder: (context, index) => Container(
                                  ...
                                  child: Column(
                                    children: [
                                      Text(
                                          'Take ${snapshot.data![index].labels} ${snapshot.data![index].quantity} during the ${snapshot.data![index].instructions}'),
