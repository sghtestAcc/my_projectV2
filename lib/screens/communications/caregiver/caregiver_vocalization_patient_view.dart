...
class CaregiverPrescriptionViewPatient extends StatefulWidget {
  ...
  @override
  State<CaregiverPrescriptionViewPatient> createState() =>
      _CaregiverPrescriptionViewPatientState();
}

class _CaregiverPrescriptionViewPatientState
    extends State<CaregiverPrescriptionViewPatient> {
      ...
      body: Column(
        children: [
          Container(
            ...
            child: Text(
              AppLocalizations.of(context)!.selectPateientmedication,
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  GestureDetector(
                                      child: Text(
                                        AppLocalizations.of(context)!.viewmor,
